...
alignedPairs i ([_, _], [])
  | i `elem`
      [BT16ri8, BT16rr, BT16ur, BT32ri8, BT32rr, BT32ur, BT64ri8, BT64rr,
       BT64ur, BTC16ri8, BTC16rr, BTC16ur, BTC32ri8, BTC32rr, BTC32ur,
       BTC64ri8, BTC64rr, BTC64ur, BTR16ri8, BTR16rr, BTR16ur, BTR32ri8,
       BTR32rr, BTR32ur, BTR64ri8, BTR64rr, BTR64ur, BTS16ri8, BTS16rr,
       BTS16ur, BTS32ri8, BTS32rr, BTS32ur, BTS64ri8, BTS64rr, BTS64ur,
       CMP16ri, CMP16ri8, CMP16rr, CMP16rr_REV, CMP16ru, CMP16ur, CMP32ri,
       CMP32ri8, CMP32rr, CMP32rr_REV, CMP32ru, CMP32ur, CMP64ri32,
       CMP64ri8, CMP64rr, CMP64rr_REV, CMP64ru, CMP64ur, CMP8ri, CMP8ri8,
       CMP8rr, CMP8rr_REV, CMP8ru, CMP8ur, COMISDrr, COMISDru, COMISSrr,
       COMISSru, Int_COMISDrr, Int_COMISDru, Int_COMISSrr, Int_COMISSru,
       Int_UCOMISDrr, Int_UCOMISDru, Int_UCOMISSrr, Int_UCOMISSru,
       Int_VCOMISDrr, Int_VCOMISDru, Int_VCOMISSrr, Int_VCOMISSru,
       Int_VUCOMISDrr, Int_VUCOMISDru, Int_VUCOMISSrr, Int_VUCOMISSru,
       PCMPISTRM128ru, PTESTrr, PTESTru, TEST16ri, TEST16rr, TEST16ru,
       TEST32ri, TEST32rr, TEST32ru, TEST64ri32, TEST64rr, TEST64ru,
       TEST8ri, TEST8rr, TEST8ru, UCOMISDrr, UCOMISDru, UCOMISSrr,
       UCOMISSru, VCOMISDrr, VCOMISDru, VCOMISSrr, VCOMISSru,
       VPCMPISTRM128ru, VPTESTYrr, VPTESTYru, VPTESTrr, VPTESTru,
       VTESTPDYrr, VTESTPDYru, VTESTPDrr, VTESTPDru, VTESTPSYrr,
       VTESTPSYru, VTESTPSrr, VTESTPSru, VUCOMISDrr, VUCOMISDru,
       VUCOMISSrr, VUCOMISSru]
    = []
alignedPairs i ([_, _], [_])
...
alignedPairs i ([src1, _], [src1'])
  | i `elem`
      [ADC16ri, ADC16ri8, ADC16rr, ADC16rr_REV, ADC16ru, ADC16ur,
       ADC32ri, ADC32ri8, ADC32rr, ADC32rr_REV, ADC32ru, ADC32ur,
       ADC64ri32, ADC64ri8, ADC64rr, ADC64rr_REV, ADC64ru, ADC64ur,
       ADC8ri, ADC8ri8, ADC8rr, ADC8rr_REV, ADC8ru, ADC8ur, ADCX32ru,
       ADCX64ru, ADD16ri, ADD16ri8, ADD16ri8_DB, ADD16ri_DB, ADD16rr,
       ADD16rr_DB, ADD16rr_REV, ADD16ru, ADD16ur, ADD32ri, ADD32ri8,
       ADD32ri8_DB, ADD32ri_DB, ADD32rr, ADD32rr_DB, ADD32rr_REV, ADD32ru,
       ADD32ur, ADD64ri32, ADD64ri32_DB, ADD64ri8, ADD64ri8_DB, ADD64rr,
       ADD64rr_DB, ADD64rr_REV, ADD64ru, ADD64ur, ADD8ri, ADD8ri8, ADD8rr,
       ADD8rr_REV, ADD8ru, ADD8ur, ADDPDrr, ADDPDru, ADDPSrr, ADDPSru,
       ADDSDrr, ADDSDrr_Int, ADDSDru, ADDSSrr, ADDSSrr_Int, ADDSSru,
       ADDSUBPDrr, ADDSUBPDru, ADDSUBPSrr, ADDSUBPSru, AESDECLASTrr,
       AESDECLASTru, AESDECrr, AESDECru, AESENCLASTrr, AESENCLASTru,
       AESENCrr, AESENCru, AND16ri, AND16ri8, AND16rr, AND16rr_REV,
       AND16ru, AND16ur, AND32ri, AND32ri8, AND32rr, AND32rr_REV, AND32ru,
       AND32ur, AND64ri32, AND64ri8, AND64rr, AND64rr_REV, AND64ru,
       AND64ur, AND8ri, AND8ri8, AND8rr, AND8rr_REV, AND8ru, AND8ur,
       ANDNPDrr, ANDNPDru, ANDNPSrr, ANDNPSru, ANDPDrr, ANDPDru, ANDPSrr,
       ANDPSru, BLENDVPDrr0, BLENDVPSrr0, CMOVA16rr, CMOVA16ru, CMOVA32rr,
       CMOVA32ru, CMOVA64rr, CMOVA64ru, CMOVAE16rr, CMOVAE16ru,
       CMOVAE32rr, CMOVAE32ru, CMOVAE64rr, CMOVAE64ru, CMOVB16rr,
       CMOVB16ru, CMOVB32rr, CMOVB32ru, CMOVB64rr, CMOVB64ru, CMOVBE16rr,
       CMOVBE16ru, CMOVBE32rr, CMOVBE32ru, CMOVBE64rr, CMOVBE64ru,
       CMOVE16rr, CMOVE16ru, CMOVE32rr, CMOVE32ru, CMOVE64rr, CMOVE64ru,
       CMOVG16rr, CMOVG16ru, CMOVG32rr, CMOVG32ru, CMOVG64rr, CMOVG64ru,
       CMOVGE16rr, CMOVGE16ru, CMOVGE32rr, CMOVGE32ru, CMOVGE64rr,
       CMOVGE64ru, CMOVL16rr, CMOVL16ru, CMOVL32rr, CMOVL32ru, CMOVL64rr,
       CMOVL64ru, CMOVLE16rr, CMOVLE16ru, CMOVLE32rr, CMOVLE32ru,
       CMOVLE64rr, CMOVLE64ru, CMOVNE16rr, CMOVNE16ru, CMOVNE32rr,
       CMOVNE32ru, CMOVNE64rr, CMOVNE64ru, CMOVNO16rr, CMOVNO16ru,
       CMOVNO32rr, CMOVNO32ru, CMOVNO64rr, CMOVNO64ru, CMOVNP16rr,
       CMOVNP16ru, CMOVNP32rr, CMOVNP32ru, CMOVNP64rr, CMOVNP64ru,
       CMOVNS16rr, CMOVNS16ru, CMOVNS32rr, CMOVNS32ru, CMOVNS64rr,
       CMOVNS64ru, CMOVO16rr, CMOVO16ru, CMOVO32rr, CMOVO32ru, CMOVO64rr,
       CMOVO64ru, CMOVP16rr, CMOVP16ru, CMOVP32rr, CMOVP32ru, CMOVP64rr,
       CMOVP64ru, CMOVS16rr, CMOVS16ru, CMOVS32rr, CMOVS32ru, CMOVS64rr,
       CMOVS64ru, CMPSDru, CMPSSru, CRC32r32r16, CRC32r32r32, CRC32r32r8,
       CRC32r64r64, CRC32r64r8, DIVPDrr, DIVPDru, DIVPSrr, DIVPSru,
       DIVSDrr, DIVSDrr_Int, DIVSDru, DIVSSrr, DIVSSrr_Int, DIVSSru,
       FsANDNPDrr, FsANDNPDru, FsANDNPSrr, FsANDNPSru, FsANDPDrr,
       FsANDPDru, FsANDPSrr, FsANDPSru, FsORPDrr, FsORPDru, FsORPSrr,
       FsORPSru, FsXORPDrr, FsXORPDru, FsXORPSrr, FsXORPSru, FvANDNPDrr,
       FvANDNPDru, FvANDNPSrr, FvANDNPSru, FvANDPDrr, FvANDPDru,
       FvANDPSrr, FvANDPSru, FvORPDrr, FvORPDru, FvORPSrr, FvORPSru,
       FvXORPDrr, FvXORPDru, FvXORPSrr, FvXORPSru, HADDPDrr, HADDPDru,
       HADDPSrr, HADDPSru, HSUBPDrr, HSUBPDru, HSUBPSrr, HSUBPSru,
       IMUL16rr, IMUL16ru, IMUL32rr, IMUL32ru, IMUL64rr, IMUL64ru,
       INSERTPSru, Int_CVTSD2SSrr, Int_CVTSD2SSru, Int_CVTSI2SD64rr,
       Int_CVTSI2SD64ru, Int_CVTSI2SDrr, Int_CVTSI2SDru, Int_CVTSI2SS64rr,
       Int_CVTSI2SS64ru, Int_CVTSI2SSrr, Int_CVTSI2SSru, Int_CVTSS2SDrr,
       Int_CVTSS2SDru, MAXCPDrr, MAXCPDru, MAXCPSrr, MAXCPSru, MAXCSDrr,
       MAXCSDru, MAXCSSrr, MAXCSSru, MAXPDrr, MAXPDru, MAXPSrr, MAXPSru,
       MAXSDrr, MAXSDrr_Int, MAXSDru, MAXSSrr, MAXSSrr_Int, MAXSSru,
       MINCPDrr, MINCPDru, MINCPSrr, MINCPSru, MINCSDrr, MINCSDru,
       MINCSSrr, MINCSSru, MINPDrr, MINPDru, MINPSrr, MINPSru, MINSDrr,
       MINSDrr_Int, MINSDru, MINSSrr, MINSSrr_Int, MINSSru, MOVHLPSrr,
       MOVLHPSrr, MOVSDrr, MOVSDrr_REV, MOVSDru, MOVSDur, MOVSSrr,
       MOVSSrr_REV, MOVSSru, MOVSSur, MULPDrr, MULPDru, MULPSrr, MULPSru,
       MULSDrr, MULSDrr_Int, MULSDru, MULSSrr, MULSSrr_Int, MULSSru,
       OR16ri, OR16ri8, OR16rr, OR16rr_REV, OR16ru, OR16ur, OR32ri,
       OR32ri8, OR32rr, OR32rr_REV, OR32ru, OR32ur, OR64ri32, OR64ri8,
       OR64rr, OR64rr_REV, OR64ru, OR64ur, OR8ri, OR8ri8, OR8rr,
       OR8rr_REV, OR8ru, OR8ur, ORPDrr, ORPDru, ORPSrr, ORPSru,
       PACKSSDWrr, PACKSSDWru, PACKSSWBrr, PACKSSWBru, PACKUSDWrr,
       PACKUSDWru, PACKUSWBrr, PACKUSWBru, PADDBrr, PADDBru, PADDDrr,
       PADDDru, PADDQrr, PADDQru, PADDSBrr, PADDSBru, PADDSWrr, PADDSWru,
       PADDUSBrr, PADDUSBru, PADDUSWrr, PADDUSWru, PADDWrr, PADDWru,
       PALIGNR128ru, PANDNrr, PANDNru, PANDrr, PANDru, PAVGBrr, PAVGBru,
       PAVGWrr, PAVGWru, PBLENDVBrr0, PCLMULQDQru, PCMPEQBrr, PCMPEQBru,
       PCMPEQDrr, PCMPEQDru, PCMPEQQrr, PCMPEQQru, PCMPEQWrr, PCMPEQWru,
       PCMPGTBrr, PCMPGTBru, PCMPGTDrr, PCMPGTDru, PCMPGTQrr, PCMPGTQru,
       PCMPGTWrr, PCMPGTWru, PHADDDrr, PHADDDru, PHADDSWrr128, PHADDWrr,
       PHADDWru, PHSUBDrr, PHSUBDru, PHSUBSWrr128, PHSUBWrr, PHSUBWru,
       PINSRDru, PINSRQru, PMADDUBSWrr128, PMADDWDrr, PMADDWDru, PMAXSBrr,
       PMAXSBru, PMAXSDrr, PMAXSDru, PMAXSWrr, PMAXSWru, PMAXUBrr,
       PMAXUBru, PMAXUDrr, PMAXUDru, PMAXUWrr, PMAXUWru, PMINSBrr,
       PMINSBru, PMINSDrr, PMINSDru, PMINSWrr, PMINSWru, PMINUBrr,
       PMINUBru, PMINUDrr, PMINUDru, PMINUWrr, PMINUWru, PMULDQrr,
       PMULDQru, PMULHRSWrr128, PMULHUWrr, PMULHUWru, PMULHWrr, PMULHWru,
       PMULLDrr, PMULLDru, PMULLWrr, PMULLWru, PMULUDQrr, PMULUDQru,
       PORrr, PORru, PSADBWrr, PSADBWru, PSHUFBrr, PSHUFBru, PSIGNBrr,
       PSIGNBru, PSIGNDrr, PSIGNDru, PSIGNWrr, PSIGNWru, PSLLDQri,
       PSLLDri, PSLLDrr, PSLLDru, PSLLQri, PSLLQrr, PSLLQru, PSLLWri,
       PSLLWrr, PSLLWru, PSRADri, PSRADrr, PSRADru, PSRAWri, PSRAWrr,
       PSRAWru, PSRLDQri, PSRLDri, PSRLDrr, PSRLDru, PSRLQri, PSRLQrr,
       PSRLQru, PSRLWri, PSRLWrr, PSRLWru, PSUBBrr, PSUBBru, PSUBDrr,
       PSUBDru, PSUBQrr, PSUBQru, PSUBSBrr, PSUBSBru, PSUBSWrr, PSUBSWru,
       PSUBUSBrr, PSUBUSBru, PSUBUSWrr, PSUBUSWru, PSUBWrr, PSUBWru,
       PUNPCKHBWrr, PUNPCKHBWru, PUNPCKHDQrr, PUNPCKHDQru, PUNPCKHQDQrr,
       PUNPCKHQDQru, PUNPCKHWDrr, PUNPCKHWDru, PUNPCKLBWrr, PUNPCKLBWru,
       PUNPCKLDQrr, PUNPCKLDQru, PUNPCKLQDQrr, PUNPCKLQDQru, PUNPCKLWDrr,
       PUNPCKLWDru, PXORrr, PXORru, RCPSSr_Int, ROL16ri, ROL32ri, ROL64ri,
       ROL8ri, ROR16ri, ROR32ri, ROR64ri, ROR8ri, RSQRTSSr_Int, SAR16ri,
       SAR32ri, SAR64ri, SAR8ri, SBB16ri, SBB16ri8, SBB16rr, SBB16rr_REV,
       SBB16ru, SBB16ur, SBB32ri, SBB32ri8, SBB32rr, SBB32rr_REV, SBB32ru,
       SBB32ur, SBB64ri32, SBB64ri8, SBB64rr, SBB64rr_REV, SBB64ru,
       SBB64ur, SBB8ri, SBB8ri8, SBB8rr, SBB8rr_REV, SBB8ru, SBB8ur,
       SHA1MSG1rr, SHA1MSG1ru, SHA1MSG2rr, SHA1MSG2ru, SHA1NEXTErr,
       SHA1NEXTEru, SHA256MSG1rr, SHA256MSG1ru, SHA256MSG2rr,
       SHA256MSG2ru, SHA256RNDS2rr, SHA256RNDS2ru, SHL16ri, SHL32ri,
       SHL64ri, SHL8ri, SHR16ri, SHR32ri, SHR64ri, SHR8ri, SQRTSDr_Int,
       SQRTSSr_Int, SUB16ri, SUB16ri8, SUB16rr, SUB16rr_REV, SUB16ru,
       SUB16ur, SUB32ri, SUB32ri8, SUB32rr, SUB32rr_REV, SUB32ru, SUB32ur,
       SUB64ri32, SUB64ri8, SUB64rr, SUB64rr_REV, SUB64ru, SUB64ur,
       SUB8ri, SUB8ri8, SUB8rr, SUB8rr_REV, SUB8ru, SUB8ur, SUBPDrr,
       SUBPDru, SUBPSrr, SUBPSru, SUBSDrr, SUBSDrr_Int, SUBSDru, SUBSSrr,
       SUBSSrr_Int, SUBSSru, UNPCKHPDrr, UNPCKHPDru, UNPCKHPSrr,
       UNPCKHPSru, UNPCKLPDrr, UNPCKLPDru, UNPCKLPSrr, UNPCKLPSru,
       XCHG16ru, XCHG32ru, XCHG64ru, XCHG8ru, XOR16ri, XOR16ri8, XOR16rr,
       XOR16rr_REV, XOR16ru, XOR16ur, XOR32ri, XOR32ri8, XOR32rr,
       XOR32rr_REV, XOR32ru, XOR32ur, XOR64ri32, XOR64ri8, XOR64rr,
       XOR64rr_REV, XOR64ru, XOR64ur, XOR8ri, XOR8ri8, XOR8rr, XOR8rr_REV,
       XOR8ru, XOR8ur, XORPDrr, XORPDru, XORPSrr, XORPSru]
    = [(src1, src1')]
alignedPairs i ([src1, _, _], [src1'])
  | i `elem`
...
alignedPairs i ([_], [_])
  | i `elem`
      [ADOX32ru, ADOX64ru, AESIMCru, AESKEYGENASSIST128ru, ARPL16ur,
       ...
       BSR32ru, BSR64ru, CMPXCHG16ru, CMPXCHG32ru, CMPXCHG64ru,
       CMPXCHG8ru, CVTDQ2PDru, CVTDQ2PSru, CVTPD2DQru, CVTPD2PSru,
       CVTPS2DQru, CVTPS2PDru, CVTSD2SI64ru, CVTSD2SIru, CVTSD2SSru,
       CVTSI2SD64ru, CVTSI2SDru, CVTSI2SS64ru, CVTSI2SSru, CVTSS2SDru,
       CVTSS2SI64ru, CVTSS2SIru, CVTTPD2DQru, CVTTPS2DQru, CVTTSD2SI64ru,
       CVTTSD2SIru, CVTTSS2SI64ru, CVTTSS2SIru, Int_CVTTSD2SI64ru,
       Int_CVTTSD2SIru, Int_CVTTSS2SI64ru, Int_CVTTSS2SIru,
       Int_VCVTTSD2SI64ru, Int_VCVTTSD2SIru, Int_VCVTTSS2SI64ru,
       Int_VCVTTSS2SIru, LAR16ru, LAR32ru, LAR64ru, LSL16ru, LSL32ru,
       LSL64ru, LZCNT16ru, LZCNT32ru, LZCNT64ru, MOV16ru, MOV16ur,
       MOV32ru, MOV32ur, MOV64ru, MOV64toPQIru, MOV64toSDru, MOV64ur,
       MOV8ru, MOV8ur, MOVAPDru, MOVAPDur, MOVAPSru, MOVAPSur, MOVDDUPru,
       MOVDI2PDIru, MOVDI2SSru, MOVDQAru, MOVDQAur, MOVDQUru, MOVDQUur,
       MOVPDI2DIur, MOVPQI2QIur, MOVPQIto64ru, MOVSDto64ur, MOVSHDUPru,
       MOVSLDUPru, MOVSS2DIur, MOVUPDru, MOVUPDur, MOVUPSru, MOVUPSur,
       MOVZPQILo2PQIru, PEXTRDur, PEXTRQur, PMOVSXBDru, PMOVSXBQru,
       PMOVSXBWru, PMOVSXDQru, PMOVSXWDru, PMOVSXWQru, PMOVZXBDru,
       PMOVZXBQru, PMOVZXBWru, PMOVZXDQru, PMOVZXWDru, PMOVZXWQru,
       POPCNT16ru, POPCNT32ru, POPCNT64ru, T1MSKC32ru, T1MSKC64ru,
       TZCNT16ru, TZCNT32ru, TZCNT64ru, TZMSK32ru, TZMSK64ru, VAESIMCru,
       VAESKEYGENASSIST128ru, VBROADCASTSDYru, VBROADCASTSSYru,
       VBROADCASTSSru, VCVTDQ2PDYru, VCVTDQ2PDru, VCVTDQ2PSYru,
       VCVTDQ2PSru, VCVTPD2DQYru, VCVTPD2PSYru, VCVTPH2PSYru, VCVTPH2PSru,
       ...
       VPBROADCASTQru, VPBROADCASTWYru, VPBROADCASTWru, VPEXTRDur,
       ...
       XADD16ru, XADD32ru, XADD64ru, XADD8ru]
    = []
