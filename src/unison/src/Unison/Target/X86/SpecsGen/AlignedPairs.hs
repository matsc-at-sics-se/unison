...
alignedPairs i ([src1, _], [src1'])
  | i `elem`
      [ADC16ri, ADC16ri8, ADC16rr, ADC16rr_REV, ADC32ri, ADC32ri8,
       ...
       ADD64rr, ADD64rr_DB, ADD64rr_REV, ADD64ru, ADD64ur, ADD8ri,
       ADD8ri8, ADD8rr, ADD8rr_REV, ADDPDrr, ADDPSrr, ADDSDrr,
       ADDSDrr_Int, ADDSSrr, ADDSSrr_Int, ADDSUBPDrr, ADDSUBPSrr,
       AESDECLASTrr, AESDECrr, AESENCLASTrr, AESENCrr, AND16ri, AND16ri8,
       AND16rr, AND16rr_REV, AND32ri, AND32ri8, AND32rr, AND32rr_REV,
       AND64ri32, AND64ri8, AND64rr, AND64rr_REV, AND8ri, AND8ri8, AND8rr,
       AND8rr_REV, ANDNPDrr, ANDNPSrr, ANDPDrr, ANDPSrr, BLENDVPDrr0,
       BLENDVPSrr0, CMOVA16rr, CMOVA32rr, CMOVA64rr, CMOVAE16rr,
       CMOVAE32rr, CMOVAE64rr, CMOVB16rr, CMOVB32rr, CMOVB64rr,
       CMOVBE16rr, CMOVBE32rr, CMOVBE64rr, CMOVE16rr, CMOVE32rr,
       CMOVE64rr, CMOVG16rr, CMOVG32rr, CMOVG64rr, CMOVGE16rr, CMOVGE32rr,
       CMOVGE64rr, CMOVL16rr, CMOVL32rr, CMOVL64rr, CMOVLE16rr,
       CMOVLE32rr, CMOVLE64rr, CMOVNE16rr, CMOVNE32rr, CMOVNE64rr,
       CMOVNO16rr, CMOVNO32rr, CMOVNO64rr, CMOVNP16rr, CMOVNP32rr,
       CMOVNP64rr, CMOVNS16rr, CMOVNS32rr, CMOVNS64rr, CMOVO16rr,
       CMOVO32rr, CMOVO64rr, CMOVP16rr, CMOVP32rr, CMOVP64rr, CMOVS16rr,
       CMOVS32rr, CMOVS64rr, CRC32r32r16, CRC32r32r32, CRC32r32r8,
       CRC32r64r64, CRC32r64r8, DIVPDrr, DIVPSrr, DIVSDrr, DIVSDrr_Int,
       DIVSSrr, DIVSSrr_Int, FsANDNPDrr, FsANDNPSrr, FsANDPDrr, FsANDPSrr,
