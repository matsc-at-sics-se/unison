...
alignedPairs i ([src1, _], [src1'])
  | i `elem`
      [ADC16ri, ADC16ri8, ADC16rr, ADC16rr_REV, ADC32ri, ADC32ri8,
       ...
       ADD8ri8, ADD8rr, ADD8rr_REV, ADDPDrr, ADDPSrr, ADDSDrr, ADDSSrr,
       ADDSUBPDrr, ADDSUBPSrr, AND16ri, AND16ri8, AND16rr, AND16rr_REV,
       AND32ri, AND32ri8, AND32rr, AND32rr_REV, AND64ri32, AND64ri8,
       AND64rr, AND64rr_REV, AND8ri, AND8ri8, AND8rr, AND8rr_REV,
       ANDNPDrr, ANDNPSrr, ANDPDrr, ANDPSrr, CMOVA16rr, CMOVA32rr,
       CMOVA64rr, CMOVAE16rr, CMOVAE32rr, CMOVAE64rr, CMOVB16rr,
       CMOVB32rr, CMOVB64rr, CMOVBE16rr, CMOVBE32rr, CMOVBE64rr,
       CMOVE16rr, CMOVE32rr, CMOVE64rr, CMOVG16rr, CMOVG32rr, CMOVG64rr,
       CMOVGE16rr, CMOVGE32rr, CMOVGE64rr, CMOVL16rr, CMOVL32rr,
       CMOVL64rr, CMOVLE16rr, CMOVLE32rr, CMOVLE64rr, CMOVNE16rr,
       CMOVNE32rr, CMOVNE64rr, CMOVNO16rr, CMOVNO32rr, CMOVNO64rr,
       CMOVNP16rr, CMOVNP32rr, CMOVNP64rr, CMOVNS16rr, CMOVNS32rr,
       CMOVNS64rr, CMOVO16rr, CMOVO32rr, CMOVO64rr, CMOVP16rr, CMOVP32rr,
       CMOVP64rr, CMOVS16rr, CMOVS32rr, CMOVS64rr, DIVPDrr, DIVPSrr,
       DIVSDrr, DIVSSrr, FsANDNPDrr, FsANDNPSrr, FsANDPDrr, FsANDPSrr,
       FsORPDrr, FsORPSrr, FsXORPDrr, FsXORPSrr, FvANDNPDrr, FvANDNPSrr,
       FvANDPDrr, FvANDPSrr, FvORPDrr, FvORPSrr, FvXORPDrr, FvXORPSrr,
       IMUL16rr, IMUL32rr, IMUL64rr, MAXCPDrr, MAXCPSrr, MAXCSDrr,
       MAXCSSrr, MAXPDrr, MAXPSrr, MAXSDrr, MAXSSrr, MINCPDrr, MINCPSrr,
       MINCSDrr, MINCSSrr, MINPDrr, MINPSrr, MINSDrr, MINSSrr, MOVHLPSrr,
       MOVLHPSrr, MOVSDrr, MOVSDrr_REV, MOVSSrr, MOVSSrr_REV, MULPDrr,
       MULPSrr, MULSDrr, MULSSrr, OR16ri, OR16ri8, OR16rr, OR16rr_REV,
       OR32ri, OR32ri8, OR32rr, OR32rr_REV, OR64ri32, OR64ri8, OR64rr,
       OR64rr_REV, OR8ri, OR8ri8, OR8rr, OR8rr_REV, ORPDrr, ORPSrr,
