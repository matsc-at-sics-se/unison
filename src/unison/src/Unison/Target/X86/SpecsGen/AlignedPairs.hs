...
alignedPairs i ([], [_])
  | i `elem`
      [AVX2_SETALLONES, AVX2_SETALLONES_source, AVX_SET0,
       ...
       MOV32r_1, MOV32r_1_source, MOV_FROM_SP, RDFLAGS32, RDFLAGS64,
       RDFSBASE, RDFSBASE64, RDGSBASE, RDGSBASE64, RDPKRU, RDRAND16r,
       RDRAND32r, RDRAND64r, RDSEED16r, RDSEED32r, RDSEED64r, SETAEr,
       SETAr, SETBEr, SETB_C16r, SETB_C32r, SETB_C64r, SETB_C8r, SETBr,
       SETEr, SETGEr, SETGr, SETLEr, SETLr, SETNEr, SETNOr, SETNPr,
       SETNSr, SETOr, SETPr, SETSr, SLDT16r, SLDT32r, SLDT64r, SMSW16r,
       SMSW32r, SMSW64r, STR16r, STR32r, STR64r, V_SET0, V_SET0_source,
       V_SETALLONES, V_SETALLONES_source, XBEGIN]
    = []
