...
alignedPairs i ([_], [_])
  | i `elem`
      [ADOX32rr, ADOX64rr, ARPL16rr, AVX2_SETALLONES_demat,
       ...
       CVTTSS2SI64rr, CVTTSS2SIrr, FsFLD0SD_demat, FsFLD0SD_remat,
       FsFLD0SS_demat, FsFLD0SS_remat, Int_CVTTSD2SI64rr, Int_CVTTSD2SIrr,
       Int_CVTTSS2SI64rr, Int_CVTTSS2SIrr, Int_VCVTTSD2SI64rr,
       Int_VCVTTSD2SIrr, Int_VCVTTSS2SI64rr, Int_VCVTTSS2SIrr, LAR16rr,
       LAR32rr, LAR64rr, LEA16r_demat, LEA16r_remat, LEA32r_demat,
       LEA32r_remat, LEA64r_demat, LEA64r_remat, LSL16rr, LSL32rr,
       LSL64rr, LZCNT16rr, LZCNT32rr, LZCNT64rr, MOV16ri, MOV16ri_alt,
       ...
       MOVE32, MOVE64, MOVE8, MOVMSKPDrr, MOVMSKPSrr, MOVPDI2DIrr,
