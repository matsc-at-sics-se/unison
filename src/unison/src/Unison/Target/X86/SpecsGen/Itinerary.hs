...
itinerary i
  ...
  | i `elem`
      [ADD16i16, ADD16ri, ADD16ri8, ADD16rr, ADD16rr_REV, ADD32i32,
       ...
       ADD8rr_REV, ADDRSP_pseudo, ADOX32rr, ADOX64rr, AND16i16, AND16ri,
       AND16ri8, AND16rr, AND16rr_REV, AND32i32, AND32ri, AND32ri8,
       AND32rr, AND32rr_REV, AND64i32, AND64ri32, AND64ri8, AND64rr,
       AND64rr_REV, AND8i8, AND8ri, AND8ri8, AND8rr, AND8rr_REV, ANDN32rr,
       ANDN64rr, CMP16i16, CMP16ri, CMP16ri8, CMP16rr, CMP16rr_REV,
       CMP32i32, CMP32ri, CMP32ri8, CMP32rr, CMP32rr_REV, CMP64i32,
       CMP64ri32, CMP64ri8, CMP64rr, CMP64rr_REV, CMP8i8, CMP8ri, CMP8ri8,
       CMP8rr, CMP8rr_REV, OR16i16, OR16ri, OR16ri8, OR16rr, OR16rr_REV,
       OR32i32, OR32ri, OR32ri8, OR32rr, OR32rr_REV, OR64i32, OR64ri32,
       OR64ri8, OR64rr, OR64rr_REV, OR8i8, OR8ri, OR8ri8, OR8rr,
       OR8rr_REV, SUB16i16, SUB16ri, SUB16ri8, SUB16rr, SUB16rr_REV,
       SUB32i32, SUB32ri, SUB32ri8, SUB32rr, SUB32rr_REV, SUB64i32,
       SUB64ri32, SUB64ri8, SUB64rr, SUB64rr_REV, SUB8i8, SUB8ri, SUB8ri8,
       SUB8rr, SUB8rr_REV, SUBRSP_pseudo, TEST16i16, TEST16ri, TEST16rr,
       TEST32i32, TEST32ri, TEST32rr, TEST64i32, TEST64ri32, TEST64rr,
       TEST8i8, TEST8ri, TEST8ri_NOREX, TEST8rr, XOR16i16, XOR16ri,
       XOR16ri8, XOR16rr, XOR16rr_REV, XOR32i32, XOR32ri, XOR32ri8,
       XOR32rr, XOR32rr_REV, XOR64i32, XOR64ri32, XOR64ri8, XOR64rr,
       XOR64rr_REV, XOR8i8, XOR8ri, XOR8ri8, XOR8rr, XOR8rr_REV]
    = IIC_BIN_NONMEM
  ...
  | i `elem`
      [ACQUIRE_MOV16rm, ACQUIRE_MOV32rm, ACQUIRE_MOV64rm, ACQUIRE_MOV8rm,
       ...
       BLCS32rm, BLCS32rr, BLCS64rm, BLCS64rr, BLSFILL32rm, BLSFILL32rr,
       ...
       FS_PREFIX, FsFLD0SD, FsFLD0SS, GC_LABEL, GETSEC, GS_PREFIX,
       ...
       LOCAL_ESCAPE, LOCK_PREFIX, LZCNT16rm, LZCNT16rr, LZCNT32rm,
       LZCNT32rr, LZCNT64rm, LZCNT64rr, MMX_CVTPI2PSirm, MONITOR, MONTMUL,
       ...
       MOVNTSD, MOVNTSS, MOVPC32r, ORPDrm, ORPDrr, ORPSrm, ORPSrr,
