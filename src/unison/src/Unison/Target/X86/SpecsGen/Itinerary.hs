...
itinerary i
  ...
  | i `elem`
    ...
    = NoItinerary
  | i `elem`
      [ADD16ri, ADD16rr, ADD16rr_REV, ADD32ri, ADD32ri_LEA, ADD32rr,
       ADD32rr_LEA, ADD32rr_REV, ADD64rr, ADD64rr_LEA, ADD64rr_REV,
       ADD8i8, ADD8ri, ADD8rr, ADD8rr_REV, AND16ri, AND16rr, AND16rr_REV,
       AND32ri, AND32rr, AND32rr_REV, AND64rr, AND64rr_REV, AND8i8,
       AND8ri, AND8rr, AND8rr_REV, CBW, CLC, CMC, CMP16ri, CMP16rr,
       CMP16rr_REV, CMP32ri, CMP32rr, CMP32rr_REV, CMP64rr, CMP64rr_REV,
       CMP8i8, CMP8ri, CMP8rr, CMP8rr_REV, CWDE, DEC16r, DEC32r, DEC64r,
       DEC8r, IMOVE16, IMOVE32, IMOVE64, IMOVE8, INC16r, INC32r, INC64r,
       INC8r, LAHF, MOV16rr, MOV16rr_REV, MOV32rr, MOV32rr_REV, MOV64rr,
       MOV64rr_REV, MOV8ri, MOV8ri_alt, MOV8ri_remat, MOV8rr, MOV8rr_REV,
       MOVSX16rr8, MOVSX32rr16, MOVSX32rr8, MOVSX64rr16, MOVSX64rr32,
       MOVSX64rr8, MOVZX16rr8, MOVZX32rr16, MOVZX32rr8, MOVZX64rr16,
       MOVZX64rr8, NEG16r, NEG32r, NEG64r, NEG8r, NOOP, NOT16r, NOT32r,
       NOT64r, NOT8r, OR16ri, OR16rr, OR16rr_REV, OR32ri, OR32rr,
       OR32rr_REV, OR64rr, OR64rr_REV, OR8i8, OR8ri, OR8rr, OR8rr_REV,
       SAHF, SGDT64m, SIDT64m, SLDT64m, SLDT64m_unison, SMSW16m,
       SMSW16m_unison, SPILL, SPILL32, STC, STRm, SUB16ri, SUB16rr,
       SUB16rr_REV, SUB32ri, SUB32rr, SUB32rr_REV, SUB64rr, SUB64rr_REV,
       SUB8i8, SUB8ri, SUB8rr, SUB8rr_REV, SYSCALL, TEST16rr, TEST32rr,
       TEST64rr, TEST8i8, TEST8ri, TEST8rr, XCHG16rr, XCHG32rr, XCHG64rr,
       XOR16ri, XOR16rr, XOR16rr_REV, XOR32ri, XOR32rr, XOR32rr_REV,
       XOR64rr, XOR64rr_REV, XOR8i8, XOR8ri, XOR8rr, XOR8rr_REV]
    = SKLWriteResGroup10
  | i `elem`
  ...
  | i `elem`
    ...
    = SKLWriteResGroup33
  | i `elem` [XADD16rr, XADD32rr, XADD64rr, XADD8rr, XCHG8rr] =
    SKLWriteResGroup34
  | i `elem`
  ...
  | i `elem`
      [ADC16ri, ADC16rr, ADC16rr_REV, ADC32ri, ADC32rr, ADC32rr_REV,
       ...
       SHL32r1_LEA, SHL32ri, SHL32ri_LEA, SHL64r1, SHL64r1_LEA, SHL64ri,
       SHL64ri_LEA, SHL8r1, SHL8ri, SHLX32rr, SHLX64rr, SHR16r1, SHR16ri,
       SHR32r1, SHR32ri, SHR64r1, SHR64ri, SHR8r1, SHR8ri, SHRX32rr,
       SHRX64rr, STAC]
    = SKLWriteResGroup7
  | i `elem`
  ...
  | i `elem`
    ...
    = SKLWriteResGroup79
  | i `elem`
      [ANDN32rr, ANDN64rr, BLSI32rr, BLSI64rr, BLSMSK32rr, BLSMSK64rr,
       BLSR32rr, BLSR64rr, BZHI32rr, BZHI64rr, LEA16r, LEA16r_remat,
       LEA32r, LEA32r_remat, LEA64_32r, LEA64r, LEA64r_remat]
    = SKLWriteResGroup8
  ...
  | i `elem`
      [ADC16i16, ADC16ri8, ADC32i32, ADC32ri8, ADC64i32, ADC64ri32,
       ...
       ADD64ri8_DB, ADD64ri_LEA, ADD64rr_DB, ADD8ri8, AND16i16, AND16ri8,
       AND32i32, AND32ri8, AND64i32, AND64ri32, AND64ri8, AND8ri8,
       BEXTRI32ri, BEXTRI64ri, BLCFILL32rr, BLCFILL64rr, BLCI32rr,
       BLCI64rr, BLCIC32rr, BLCIC64rr, BLCMSK32rr, BLCMSK64rr, BLCS32rr,
       BLCS64rr, BLSFILL32rr, BLSFILL64rr, BLSIC32rr, BLSIC64rr, CDQE,
       CLI, CLTS, CMP16i16, CMP16ri8, CMP32i32, CMP32ri8, CMP64i32,
       CMP64ri32, CMP64ri8, CMP8ri8, DEC16r_alt, DEC32r_alt, FPOP, FPOP32,
       FPUSH, FPUSH32, FvANDPDrr, FvXORPDrr, INC16r_alt, INC32r_alt,
       LEAVE, MOV16ao16, MOV16ao32, MOV16o16a, MOV16o32a, MOV32ao16,
       MOV32ao32, MOV32o16a, MOV32o32a, MOV32r1, MOV32r1_remat, MOV32r_1,
       MOV32r_1_remat, MOV32ri64, MOV32ri64_remat, MOV64ao32, MOV64o32a,
       MOV64ri64, MOV64ri64_remat, MOV8ao16, MOV8ao32, MOV8o16a, MOV8o32a,
       MOVSX32_NOREXrr8, MOVZX32_NOREXrr8, NOFPOP, NOFPUSH, OR16i16,
       OR16ri8, OR32i32, OR32ri8, OR64i32, OR64ri32, OR64ri8, OR8ri8,
       SBB16i16, SBB16ri8, SBB32i32, SBB32ri8, SBB64i32, SBB64ri32,
       SBB64ri8, SBB8ri8, SETB_C16r, SETB_C32r, SETB_C64r, SETB_C8r, STI,
       SUB16i16, SUB16ri8, SUB32i32, SUB32ri8, SUB64i32, SUB64ri32,
       SUB64ri8, SUB8ri8, SUBREG_TO_REG, T1MSKC32rr, T1MSKC64rr,
       TEST16i16, TEST16ri, TEST32i32, TEST32ri, TEST64i32, TEST64ri32,
       TEST8ri_NOREX, TZMSK32rr, TZMSK64rr, VFvANDPDrr, VFvXORPDrr,
       XCHG16ar, XCHG32ar, XCHG32ar64, XCHG64ar, XOR16i16, XOR16ri8,
       XOR32i32, XOR32ri8, XOR64i32, XOR64ri32, XOR64ri8, XOR8ri8]
    = WriteALU
  | i `elem`
