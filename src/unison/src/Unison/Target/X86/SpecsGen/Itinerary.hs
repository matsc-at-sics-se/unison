...
itinerary i
  ...
  | i `elem`
      [ADD16i16, ADD16ri, ADD16ri8, ADD16rr, ADD16rr_REV, ADD32i32,
       ...
       SUB64rr_REV, SUB8i8, SUB8ri, SUB8ri8, SUB8rr, TEST16i16, TEST16ri,
       TEST16rr, TEST32i32, TEST32ri, TEST32rr, TEST64i32, TEST64ri32,
       TEST64rr, TEST8i8, TEST8ri, TEST8ri_NOREX, TEST8rr, XOR16i16,
       XOR16ri, XOR16ri8, XOR16rr, XOR16rr_REV, XOR32i32, XOR32ri,
       XOR32ri8, XOR32rr, XOR32rr_REV, XOR64i32, XOR64ri32, XOR64ri8,
       XOR64rr, XOR64rr_REV, XOR8i8, XOR8ri, XOR8ri8, XOR8rr, XOR8rr_REV]
    = IIC_BIN_NONMEM
  ...
  | i `elem`
      [JMP_1, JMP_2, JMP_4, SUB8rr_REV, TAILJMPd64, TAILJMPd64_REX]
    = IIC_JMP_REL
  | i `elem`
