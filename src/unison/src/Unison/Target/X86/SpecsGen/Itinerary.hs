...
itinerary i
  ...
  | i `elem`
      [ADD16ri, ADD16rr, ADD16rr_REV, ADD32ri, ADD32ri_LEA, ADD32rr,
       ...
       DEC8r, FPOP32, IMOVE16, IMOVE32, IMOVE64, IMOVE8, INC16r, INC32r,
       INC64r, INC8r, LAHF, MOV16rr, MOV16rr_REV, MOV32rr, MOV32rr_REV,
       MOV64rr, MOV64rr_REV, MOV8ri, MOV8ri_alt, MOV8ri_remat, MOV8rr,
       MOV8rr_REV, MOVSX16rr8, MOVSX32rr16, MOVSX32rr8, MOVSX64rr16,
       MOVSX64rr32, MOVSX64rr8, MOVZX16rr8, MOVZX32rr16, MOVZX32rr8,
       MOVZX64rr16, MOVZX64rr8, NEG16r, NEG32r, NEG64r, NEG8r, NOOP,
       NOT16r, NOT32r, NOT64r, NOT8r, OR16ri, OR16rr, OR16rr_REV, OR32ri,
       OR32rr, OR32rr_REV, OR64rr, OR64rr_REV, OR8i8, OR8ri, OR8rr,
       OR8rr_REV, SAHF, SGDT64m, SIDT64m, SLDT64m, SLDT64m_unison,
       SMSW16m, SMSW16m_unison, SPILL, SPILL32, STC, STRm, SUB16ri,
       SUB16rr, SUB16rr_REV, SUB32ri, SUB32rr, SUB32rr_REV, SUB64rr,
       SUB64rr_REV, SUB8i8, SUB8ri, SUB8rr, SUB8rr_REV, SYSCALL, TEST16rr,
       TEST32rr, TEST64rr, TEST8i8, TEST8ri, TEST8rr, XCHG16rr, XCHG32rr,
       XCHG64rr, XOR16ri, XOR16rr, XOR16rr_REV, XOR32ri, XOR32rr,
       XOR32rr_REV, XOR64rr, XOR64rr_REV, XOR8i8, XOR8ri, XOR8rr,
       XOR8rr_REV]
    = SKLWriteResGroup10
  | i `elem`
  ...
  | i `elem`
      [ADC16i16, ADC16ri8, ADC32i32, ADC32ri8, ADC64i32, ADC64ri32,
       ...
       CMP64ri32, CMP64ri8, CMP8ri8, DEC16r_alt, DEC32r_alt, FPUSH32,
       FvANDPDrr, FvXORPDrr, INC16r_alt, INC32r_alt, LEAVE, MOV16ao16,
       MOV16ao32, MOV16o16a, MOV16o32a, MOV32ao16, MOV32ao32, MOV32o16a,
       MOV32o32a, MOV32r1, MOV32r1_remat, MOV32r_1, MOV32r_1_remat,
       MOV32ri64, MOV32ri64_remat, MOV64ao32, MOV64o32a, MOV64ri64,
       MOV64ri64_remat, MOV8ao16, MOV8ao32, MOV8o16a, MOV8o32a,
