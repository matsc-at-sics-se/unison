...
itinerary i
  ...
  | i `elem`
      [ACQUIRE_MOV16rm, ACQUIRE_MOV32rm, ACQUIRE_MOV64rm, ACQUIRE_MOV8rm,
       ...
       MOVNTDQArm, MOVNTSD, MOVNTSS, MOVPC32r, ORPDrm, ORPDrm_unison,
       ORPDrr, ORPSrm, ORPSrm_unison, ORPSrr, PACKSSDWrm,
       PACKSSDWrm_unison, PACKSSDWrr, PACKSSWBrm, PACKSSWBrm_unison,
       PACKSSWBrr, PACKUSDWrm, PACKUSDWrm_unison, PACKUSDWrr, PACKUSWBrm,
       PACKUSWBrm_unison, PACKUSWBrr, PATCHPOINT, PCMPEQQrm,
       PCMPEQQrm_unison, PCMPEQQrr, PCMPESTRIMEM, PCMPESTRIREG,
       PCMPESTRIrm, PCMPESTRIrm_unison, PCMPESTRIrr, PCMPESTRM128MEM,
       PCMPESTRM128REG, PCMPESTRM128rm, PCMPESTRM128rm_unison,
       PCMPESTRM128rr, PCMPGTQrm, PCMPGTQrm_unison, PCMPGTQrr,
       PCMPISTRIMEM, PCMPISTRIREG, PCMPISTRIrm, PCMPISTRIrm_unison,
       PCMPISTRIrr, PCMPISTRM128MEM, PCMPISTRM128REG, PCMPISTRM128rm,
       PCMPISTRM128rm_unison, PCMPISTRM128rr, PCOMMIT, PDEP32rm,
       PDEP32rm_unison, PDEP32rr, PDEP64rm, PDEP64rm_unison, PDEP64rr,
       PEXT32rm, PEXT32rm_unison, PEXT32rr, PEXT64rm, PEXT64rm_unison,
       PEXT64rr, PEXTRBmr, PEXTRBrr, PEXTRDmr, PEXTRDmr_unison, PEXTRDrr,
       PEXTRQmr, PEXTRQmr_unison, PEXTRQrr, PEXTRWmr, PEXTRWrr_REV,
       PHADDSWrm128, PHADDSWrm128_unison, PHADDSWrr128, PHI,
       PHMINPOSUWrm128, PHMINPOSUWrm128_unison, PHMINPOSUWrr128,
       PHSUBSWrm128, PHSUBSWrm128_unison, PHSUBSWrr128, PINSRBrm,
       PINSRBrr, PINSRDrm, PINSRDrm_unison, PINSRDrr, PINSRQrm,
