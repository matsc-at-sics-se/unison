...
size i
  | i `elem`
      [ADC16i16, ADC16mi, ADC16mi8, ADC16mr, ADC16ri, ADC16ri8, ADC16rm,
       ...
       BTS64mi8, BTS64mr, BTS64ri8, BTS64rr, CALL16m, CALL16r, CALL32m,
       CALL32r, CALL64m, CALL64pcrel32, CALL64r, CALLpcrel16, CALLpcrel32,
       CBW, CDQ, CDQE, CLC, CLD, CMC, CMOVA16rm, CMOVA16rr, CMOVA32rm,
       ...
       LEA64r_demat, LEA64r_remat, LEA64r_source, LEAVE, LEAVE64, LOAD128,
       LOAD16, LOAD32, LOAD64, LOAD8, LODSB, LODSL, LODSQ, LODSW, LOOP,
       LOOPE, LOOPNE, MAXCPDrm, MAXCPDrr, MAXCPSrm, MAXCPSrr, MAXCSDrm,
       MAXCSDrr, MAXCSSrm, MAXCSSrr, MAXPDrm, MAXPDrr, MAXPSrm, MAXPSrr,
       MAXSDrm, MAXSDrr, MAXSSrm, MAXSSrr, MINCPDrm, MINCPDrr, MINCPSrm,
       MINCPSrr, MINCSDrm, MINCSDrr, MINCSSrm, MINCSSrr, MINPDrm, MINPDrr,
       MINPSrm, MINPSrr, MINSDrm, MINSDrr, MINSSrm, MINSSrr, MOV16ao16,
       MOV16ao32, MOV16ao64, MOV16mi, MOV16mr, MOV16o16a, MOV16o32a,
       MOV16o64a, MOV16ri, MOV16ri_alt, MOV16ri_alt_demat,
       ...
       MOVDQUrm, MOVDQUrr, MOVDQUrr_REV, MOVE128, MOVE16, MOVE32, MOVE64,
       MOVE8, MOVHLPSrr, MOVHPDmr, MOVHPDrm, MOVHPSmr, MOVHPSrm,
       MOVLHPSrr, MOVLPDmr, MOVLPDrm, MOVLPSmr, MOVLPSrm, MOVNTDQArm,
       MOVNTDQmr, MOVNTPDmr, MOVNTPSmr, MOVNTSD, MOVNTSS, MOVPDI2DImr,
       ...
       MULPSrm, MULPSrr, MULSDrm, MULSDrr, MULSSrm, MULSSrr, NEG16m,
       ...
       OR8rr_REV, ORPDrm, ORPDrr, ORPSrm, ORPSrr, PACKSSDWrm, PACKSSDWrr,
       ...
       PMULUDQrr, POP16r, POP16rmm, POP16rmr, POP32r, POP32rmm, POP32rmr,
       POP64r, POP64rmm, POP64rmr, POPCNT16rm, POPCNT16rr, POPCNT32rm,
       POPCNT32rr, POPCNT64rm, POPCNT64rr, POP_cst, PORrm, PORrr,
       PSHUFBrm, PSHUFBrr, PSHUFDmi, PSHUFDri, PSHUFHWmi, PSHUFHWri,
       PSHUFLWmi, PSHUFLWri, PSLLDQri, PSLLDri, PSLLDrm, PSLLDrr, PSLLQri,
       PSLLQrm, PSLLQrr, PSLLWri, PSLLWrm, PSLLWrr, PSRADri, PSRADrm,
       PSRADrr, PSRAWri, PSRAWrm, PSRAWrr, PSRLDQri, PSRLDri, PSRLDrm,
       PSRLDrr, PSRLQri, PSRLQrm, PSRLQrr, PSRLWri, PSRLWrm, PSRLWrr,
       PSUBBrm, PSUBBrr, PSUBDrm, PSUBDrr, PSUBQrm, PSUBQrr, PSUBWrm,
       PSUBWrr, PUNPCKHBWrm, PUNPCKHBWrr, PUNPCKHDQrm, PUNPCKHDQrr,
       ...
       PUSHGS64, PUSHSS16, PUSHSS32, PUSH_cst, PUSHi16, PUSHi32, PXORrm,
       PXORrr, RCL16m1, RCL16mCL, RCL16mi, RCL16r1, RCL16rCL, RCL16ri,
       RCL32m1, RCL32mCL, RCL32mi, RCL32r1, RCL32rCL, RCL32ri, RCL64m1,
       RCL64mCL, RCL64mi, RCL64r1, RCL64rCL, RCL64ri, RCL8m1, RCL8mCL,
       RCL8mi, RCL8r1, RCL8rCL, RCL8ri, RCR16m1, RCR16mCL, RCR16mi,
       ...
       SQRTSSr, STC, STD, STORE128, STORE16, STORE32, STORE64, STORE8,
       STOSB, STOSL, STOSQ, STOSW, SUB16i16, SUB16mi, SUB16mi8, SUB16mr,
       ...
       UCOMISSrm, UCOMISSrr, UD2B, V_SET0, V_SET0_demat, V_SET0_remat,
       V_SET0_source, V_SETALLONES, V_SETALLONES_demat,
       V_SETALLONES_remat, V_SETALLONES_source, XCHG16ar, XCHG16rm,
