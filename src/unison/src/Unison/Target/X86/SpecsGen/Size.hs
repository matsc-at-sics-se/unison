...
size i
  | i `elem`
      [ADC16i16, ADC16mi, ADC16mi8, ADC16mr, ADC16ri, ADC16ri8, ADC16rm,
       ...
       ADDSDrm, ADDSDrr, ADDSSrm, ADDSSrr, ADDSUBPDrm, ADDSUBPDrr,
       ADDSUBPSrm, ADDSUBPSrr, AND16i16, AND16mi, AND16mi8, AND16mr,
       AND16ri, AND16ri8, AND16rm, AND16rr, AND16rr_REV, AND32i32,
       AND32mi, AND32mi8, AND32mr, AND32ri, AND32ri8, AND32rm, AND32rr,
       ...
       LEA64r_demat, LEA64r_remat, LEA64r_source, LEAVE, LEAVE64, LOAD16,
       LOAD32, LOAD64, LOAD8, LODSB, LODSL, LODSQ, LODSW, LOOP, LOOPE,
       LOOPNE, MAXCPDrm, MAXCPDrr, MAXCPSrm, MAXCPSrr, MAXCSDrm, MAXCSDrr,
       MAXCSSrm, MAXCSSrr, MAXPDrm, MAXPDrr, MAXPSrm, MAXPSrr, MAXSDrm,
       MAXSDrr, MAXSSrm, MAXSSrr, MINCPDrm, MINCPDrr, MINCPSrm, MINCPSrr,
       MINCSDrm, MINCSDrr, MINCSSrm, MINCSSrr, MINPDrm, MINPDrr, MINPSrm,
       MINPSrr, MINSDrm, MINSDrr, MINSSrm, MINSSrr, MOV16ao16, MOV16ao32,
       MOV16ao64, MOV16mi, MOV16mr, MOV16o16a, MOV16o32a, MOV16o64a,
       MOV16ri, MOV16ri_alt, MOV16ri_alt_demat, MOV16ri_alt_remat,
       ...
       MOV64ri_source, MOV64rm, MOV64rr, MOV64rr_REV, MOV64toPQIrm,
       ...
       MOV8rr_REV, MOVAPDmr, MOVAPDrm, MOVAPDrr, MOVAPDrr_REV, MOVAPSmr,
       MOVAPSrm, MOVAPSrr, MOVAPSrr_REV, MOVBE16mr, MOVBE16rm, MOVBE32mr,
       MOVBE32rm, MOVBE64mr, MOVBE64rm, MOVDDUPrm, MOVDDUPrr, MOVDI2PDIrm,
       MOVDI2PDIrr, MOVDI2SSrm, MOVDI2SSrr, MOVDQAmr, MOVDQArm, MOVDQArr,
       MOVDQArr_REV, MOVDQUmr, MOVDQUrm, MOVDQUrr, MOVDQUrr_REV, MOVE16,
       MOVE32, MOVE64, MOVE8, MOVHLPSrr, MOVHPDmr, MOVHPDrm, MOVHPSmr,
       MOVHPSrm, MOVLHPSrr, MOVLPDmr, MOVLPDrm, MOVLPSmr, MOVLPSrm,
       MOVNTDQArm, MOVNTDQmr, MOVNTPDmr, MOVNTPSmr, MOVNTSD, MOVNTSS,
       MOVPDI2DImr, MOVPDI2DIrr, MOVPQI2QImr, MOVPQI2QIrr, MOVPQIto64rm,
       MOVPQIto64rr, MOVQI2PQIrm, MOVSB, MOVSDmr, MOVSDrm, MOVSDrr,
       MOVSDrr_REV, MOVSDto64mr, MOVSDto64rr, MOVSHDUPrm, MOVSHDUPrr,
       MOVSL, MOVSLDUPrm, MOVSLDUPrr, MOVSQ, MOVSS2DImr, MOVSS2DIrr,
       MOVSSmr, MOVSSrm, MOVSSrr, MOVSSrr_REV, MOVSW, MOVSX16rm8,
       ...
       MOVZX64rm8, MOVZX64rr16, MOVZX64rr8, MPSADBWrmi, MPSADBWrri,
       MUL16m, MUL16r, MUL32m, MUL32r, MUL64m, MUL64r, MUL8m, MUL8r,
       MULPDrm, MULPDrr, MULPSrm, MULPSrr, MULSDrm, MULSDrr, MULSSrm,
       MULSSrr, NEG16m, NEG16r, NEG32m, NEG32r, NEG64m, NEG64r, NEG8m,
       ...
       OR8rm, OR8rr, OR8rr_REV, ORPDrm, ORPDrr, ORPSrm, ORPSrr,
       ...
       SQRTSSr, STC, STD, STORE16, STORE32, STORE64, STORE8, STOSB, STOSL,
       ...
       SUBPDrr, SUBPSrm, SUBPSrr, SUBRSP_pseudo, SUBSDrm, SUBSDrr,
       SUBSSrm, SUBSSrr, TAILJMPd, TAILJMPd64, TAILJMPd64_REX, TAILJMPm,
       ...
       TEST8ri, TEST8ri_NOREX, TEST8rm, TEST8rr, UCOMISDrm, UCOMISDrr,
       UCOMISSrm, UCOMISSrr, UD2B, V_SET0, V_SETALLONES, XCHG16ar,
