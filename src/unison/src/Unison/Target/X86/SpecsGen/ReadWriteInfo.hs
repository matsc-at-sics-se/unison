...
readWriteInfo i
  | i `elem`
      [BSWAP32r, BSWAP64r, CLC, CLD, CMC, CMPXCHG16rr, CMPXCHG32rr,
       ...
       MOVBE32mr, MOVBE32rm, MOVBE64mr, MOVBE64rm, MOVSX16rr8,
       MOVSX32_NOREXrr8, MOVSX32rm16, MOVSX32rm8, MOVSX32rr16, MOVSX32rr8,
       MOVSX64rm16, MOVSX64rm32, MOVSX64rm8, MOVSX64rr16, MOVSX64rr32,
       MOVSX64rr8, MOVZX16rr8, MOVZX32_NOREXrr8, MOVZX32rm16, MOVZX32rm8,
       MOVZX32rr16, MOVZX32rr8, MOVZX64rr16, MOVZX64rr8, NOOP, NOOPL,
       NOOPW, NOT16m, NOT16r, NOT32m, NOT32r, NOT64m, NOT64r, NOT8m,
       NOT8r, PUSHCS16, PUSHCS32, PUSHDS16, PUSHDS32, PUSHES16, PUSHES32,
       PUSHFS16, PUSHFS32, PUSHFS64, PUSHGS16, PUSHGS32, PUSHGS64,
       PUSHSS16, PUSHSS32, RETIL, RETIQ, RETIW, RETL, RETQ, RETW,
       REX64_PREFIX, RORX32ri, RORX64ri, SARX32rr, SARX64rr, SHLX32rr,
       SHLX64rr, SHRX32rr, SHRX64rr, STC, STD, SUBREG_TO_REG, UD2B,
       XCHG16rm, XCHG16rr, XCHG32rm, XCHG32rr, XCHG64rm, XCHG64rr,
       XCHG8rm, XCHG8rr]
    = ([], [])
  | i `elem`
