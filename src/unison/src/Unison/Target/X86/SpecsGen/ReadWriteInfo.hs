...
readWriteInfo i
  | i `elem`
      [ADDPDrr, ADDPSrr, ADDSDrm, ADDSDrr, ADDSSrm, ADDSSrr, ADDSUBPDrm,
       ...
       MOVDQUrr, MOVDQUrr_REV, MOVE128, MOVE16, MOVE32, MOVE64, MOVE8,
       ...
       MOVPQI2QImr, MOVPQI2QIrr, MOVPQIto64rr, MOVQI2PQIrm, MOVSDmr,
       MOVSDrm, MOVSDrr, MOVSDrr_REV, MOVSDto64mr, MOVSDto64rr,
       MOVSHDUPrm, MOVSHDUPrr, MOVSLDUPrm, MOVSLDUPrr, MOVSS2DImr,
       MOVSS2DIrr, MOVSSmr, MOVSSrm, MOVSSrr, MOVSSrr_REV, MOVSX16rr8,
       ...
       MOVZQI2PQIrm, MOVZX16rr8, MOVZX32_NOREXrr8, MOVZX32rm16,
       MOVZX32rm8, MOVZX32rr16, MOVZX32rr8, MOVZX64rr16, MOVZX64rr8,
       MPSADBWrmi, MPSADBWrri, MULPDrr, MULPSrr, MULSDrm, MULSDrr,
       MULSSrm, MULSSrr, NOOP, NOOPL, NOOPW, NOT16m, NOT16r, NOT32m,
       ...
       PMULDQrm, PMULDQrr, PMULUDQrm, PMULUDQrr, PORrm, PORrr, PSHUFBrm,
       PSHUFBrr, PSHUFDmi, PSHUFDri, PSHUFHWmi, PSHUFHWri, PSHUFLWmi,
       PSHUFLWri, PSLLDQri, PSLLDri, PSLLDrm, PSLLDrr, PSLLQri, PSLLQrm,
       PSLLQrr, PSLLWri, PSLLWrm, PSLLWrr, PSRADri, PSRADrm, PSRADrr,
       PSRAWri, PSRAWrm, PSRAWrr, PSRLDQri, PSRLDri, PSRLDrm, PSRLDrr,
       PSRLQri, PSRLQrm, PSRLQrr, PSRLWri, PSRLWrm, PSRLWrr, PSUBBrm,
       PSUBBrr, PSUBDrm, PSUBDrr, PSUBQrm, PSUBQrr, PSUBWrm, PSUBWrr,
       ...
       PUSHGS64, PUSHSS16, PUSHSS32, PXORrm, PXORrr, RETIL, RETIQ, RETIW,
       RETL, RETQ, RETW, REX64_PREFIX, RORX32ri, RORX64ri, ROUNDPDm,
       ROUNDPDr, ROUNDPSm, ROUNDPSr, ROUNDSDm, ROUNDSDr, ROUNDSSm,
       ROUNDSSr, SARX32rr, SARX64rr, SHLX32rr, SHLX64rr, SHRX32rr,
       SHRX64rr, SQRTSDr, SQRTSSr, STC, STD, SUBPDrr, SUBPSrr, SUBSDrm,
       SUBSDrr, SUBSSrm, SUBSSrr, UD2B, V_SET0, V_SET0_demat,
       V_SET0_remat, V_SET0_source, V_SETALLONES, V_SETALLONES_demat,
       V_SETALLONES_remat, V_SETALLONES_source, XCHG16rm, XCHG16rr,
       XCHG32rm, XCHG32rr, XCHG64rm, XCHG64rr, XCHG8rm, XCHG8rr, XORPDrm,
  ...
  | i `elem`
      [ADD16mi, ADD16mi8, ADD16mr, ADD16ri, ADD16ri8, ADD16ri8_DB,
       ...
       ADD64rr, ADD64rr_DB, ADD64rr_REV, ADD64ru, ADD64ur, ADD8mi, ADD8mr,
       ADD8ri, ADD8ri8, ADD8rm, ADD8rr, ADD8rr_REV, ADDRSP_pseudo,
       AND16mi, AND16mi8, AND16mr, AND16ri, AND16ri8, AND16rm, AND16rr,
       AND16rr_REV, AND32mi, AND32mi8, AND32mr, AND32ri, AND32ri8,
       AND32rm, AND32rr, AND32rr_REV, AND64mi32, AND64mi8, AND64mr,
       AND64ri32, AND64ri8, AND64rm, AND64rr, AND64rr_REV, AND8mi, AND8mr,
       AND8ri, AND8ri8, AND8rm, AND8rr, AND8rr_REV, ANDN32rm, ANDN32rr,
       ANDN64rm, ANDN64rr, BSF16rm, BSF16rr, BSF32rm, BSF32rr, BSF64rm,
       BSF64rr, BSR16rm, BSR16rr, BSR32rm, BSR32rr, BSR64rm, BSR64rr,
       BT16mi8, BT16ri8, BT16rr, BT32mi8, BT32ri8, BT32rr, BT64mi8,
       BT64ri8, BT64rr, BTC16ri8, BTC16rr, BTC32ri8, BTC32rr, BTC64ri8,
       BTC64rr, BTR16ri8, BTR16rr, BTR32ri8, BTR32rr, BTR64ri8, BTR64rr,
       BTS16ri8, BTS16rr, BTS32ri8, BTS32rr, BTS64ri8, BTS64rr, CMP16mi,
       CMP16mi8, CMP16mr, CMP16ri, CMP16ri8, CMP16rm, CMP16rr,
       CMP16rr_REV, CMP32mi, CMP32mi8, CMP32mr, CMP32ri, CMP32ri8,
       CMP32rm, CMP32rr, CMP32rr_REV, CMP64mi32, CMP64mi8, CMP64mr,
       CMP64ri32, CMP64ri8, CMP64rm, CMP64rr, CMP64rr_REV, CMP8mi, CMP8mr,
       CMP8ri, CMP8ri8, CMP8rm, CMP8rr, CMP8rr_REV, COMISDrm, COMISDrr,
       COMISSrm, COMISSrr, DEC16m, DEC16r, DEC16r_alt, DEC32m, DEC32r,
       DEC32r_alt, DEC64m, DEC64r, DEC8m, DEC8r, IMUL16rm, IMUL16rmi,
       IMUL16rmi8, IMUL16rr, IMUL16rri, IMUL16rri8, IMUL32rm, IMUL32rmi,
       IMUL32rmi8, IMUL32rr, IMUL32rri, IMUL32rri8, IMUL64rm, IMUL64rmi32,
       IMUL64rmi8, IMUL64rr, IMUL64rri32, IMUL64rri8, INC16m, INC16r,
       INC16r_alt, INC32m, INC32r, INC32r_alt, INC64m, INC64r, INC8m,
       INC8r, MOV32r0, MOV32r0_remat, MOV32r1, MOV32r1_remat, MOV32r_1,
       MOV32r_1_remat, NEG16m, NEG16r, NEG32m, NEG32r, NEG64m, NEG64r,
       NEG8m, NEG8r, OR16mi, OR16mi8, OR16mr, OR16ri, OR16ri8, OR16rm,
       OR16rr, OR16rr_REV, OR32mi, OR32mi8, OR32mr, OR32mrLocked, OR32ri,
       OR32ri8, OR32rm, OR32rr, OR32rr_REV, OR64mi32, OR64mi8, OR64mr,
       OR64ri32, OR64ri8, OR64rm, OR64rr, OR64rr_REV, OR8mi, OR8mr, OR8ri,
       OR8ri8, OR8rm, OR8rr, OR8rr_REV, POPCNT16rm, POPCNT16rr,
       POPCNT32rm, POPCNT32rr, POPCNT64rm, POPCNT64rr, RCL16m1, RCL16mi,
       RCL16r1, RCL16ri, RCL32m1, RCL32mi, RCL32r1, RCL32ri, RCL64m1,
       RCL64mi, RCL64r1, RCL64ri, RCL8m1, RCL8mi, RCL8r1, RCL8ri, RCR16m1,
       RCR16mi, RCR16r1, RCR16ri, RCR32m1, RCR32mi, RCR32r1, RCR32ri,
       RCR64m1, RCR64mi, RCR64r1, RCR64ri, RCR8m1, RCR8mi, RCR8r1, RCR8ri,
       ROL16m1, ROL16mi, ROL16r1, ROL16ri, ROL32m1, ROL32mi, ROL32r1,
       ROL32ri, ROL64m1, ROL64mi, ROL64r1, ROL64ri, ROL8m1, ROL8mi,
       ROL8r1, ROL8ri, ROR16m1, ROR16mi, ROR16r1, ROR16ri, ROR32m1,
       ROR32mi, ROR32r1, ROR32ri, ROR64m1, ROR64mi, ROR64r1, ROR64ri,
       ROR8m1, ROR8mi, ROR8r1, ROR8ri, SAR16m1, SAR16mi, SAR16r1, SAR16ri,
       SAR32m1, SAR32mi, SAR32r1, SAR32ri, SAR64m1, SAR64mi, SAR64r1,
       SAR64ri, SAR8m1, SAR8mi, SAR8r1, SAR8ri, SHL16m1, SHL16mi, SHL16r1,
       SHL16ri, SHL32m1, SHL32mi, SHL32r1, SHL32ri, SHL64m1, SHL64mi,
       SHL64r1, SHL64ri, SHL8m1, SHL8mi, SHL8r1, SHL8ri, SHLD16mri8,
       SHLD16rri8, SHLD32mri8, SHLD32rri8, SHLD64mri8, SHLD64rri8,
       SHR16m1, SHR16mi, SHR16r1, SHR16ri, SHR32m1, SHR32mi, SHR32r1,
       SHR32ri, SHR64m1, SHR64mi, SHR64r1, SHR64ri, SHR8m1, SHR8mi,
       SHR8r1, SHR8ri, SHRD16mri8, SHRD16rri8, SHRD32mri8, SHRD32rri8,
       SHRD64mri8, SHRD64rri8, SUB16mi, SUB16mi8, SUB16mr, SUB16ri,
       SUB16ri8, SUB16rm, SUB16rr, SUB16rr_REV, SUB32mi, SUB32mi8,
       SUB32mr, SUB32ri, SUB32ri8, SUB32rm, SUB32rr, SUB32rr_REV,
       SUB64mi32, SUB64mi8, SUB64mr, SUB64ri32, SUB64ri8, SUB64rm,
       SUB64rr, SUB64rr_REV, SUB8mi, SUB8mr, SUB8ri, SUB8ri8, SUB8rm,
       SUB8rr, SUB8rr_REV, SUBRSP_pseudo, TEST16mi, TEST16ri, TEST16rm,
       TEST16rr, TEST32mi, TEST32ri, TEST32rm, TEST32rr, TEST64mi32,
       TEST64ri32, TEST64rm, TEST64rr, TEST8mi, TEST8ri, TEST8ri_NOREX,
       TEST8rm, TEST8rr, UCOMISDrm, UCOMISDrr, UCOMISSrm, UCOMISSrr,
       XOR16mi, XOR16mi8, XOR16mr, XOR16ri, XOR16ri8, XOR16rm, XOR16rr,
       XOR16rr_REV, XOR32mi, XOR32mi8, XOR32mr, XOR32ri, XOR32ri8,
       XOR32rm, XOR32rr, XOR32rr_REV, XOR64mi32, XOR64mi8, XOR64mr,
       XOR64ri32, XOR64ri8, XOR64rm, XOR64rr, XOR64rr_REV, XOR8mi, XOR8mr,
       XOR8ri, XOR8ri8, XOR8rm, XOR8rr, XOR8rr_REV]
  ...
  | i `elem` [REP_MOVSB_64, REP_MOVSD_64, REP_MOVSQ_64, REP_MOVSW_64]
    ...
    ([OtherSideEffect RCX, OtherSideEffect RDI, OtherSideEffect RSI],
     [OtherSideEffect RCX, OtherSideEffect RDI, OtherSideEffect RSI])
  | i `elem`
      [CALL64m, CALL64pcrel32, CALL64r, LOAD128, LOAD16, LOAD32, LOAD64,
       LOAD8, STORE128, STORE16, STORE32, STORE64, STORE8, TAILJMPd64,
