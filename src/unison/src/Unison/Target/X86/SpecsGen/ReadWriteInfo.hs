...
readWriteInfo i
  | i `elem`
      [ADDPDrr, ADDPSrr, ADDSDrm, ADDSDrr, ADDSSrm, ADDSSrr, ADDSUBPDrm,
       ...
       NOT8r, ORPDrm, ORPDrr, ORPSrm, ORPSrr, PADDBrm, PADDBrr, PADDDrm,
       PADDDrr, PADDQrm, PADDQrr, PADDWrm, PADDWrr, PANDNrm, PANDNrr,
       PANDrm, PANDrr, PCMPEQBrm, PCMPEQBrr, PCMPEQDrm, PCMPEQDrr,
       PCMPEQQrm, PCMPEQQrr, PCMPEQWrm, PCMPEQWrr, PMULDQrm, PMULDQrr,
       PMULUDQrm, PMULUDQrr, PORrm, PORrr, PSHUFBrm, PSHUFBrr, PSHUFDmi,
       ...
       PUSHSS16, PUSHSS32, PXORrm, PXORrr, RETIL, RETIQ, RETIW, RETL,
       RETQ, RETW, REX64_PREFIX, RORX32ri, RORX64ri, ROUNDPDm, ROUNDPDr,
       ROUNDPSm, ROUNDPSr, ROUNDSDm, ROUNDSDr, ROUNDSSm, ROUNDSSr,
       SARX32rr, SARX64rr, SHLX32rr, SHLX64rr, SHRX32rr, SHRX64rr,
       SQRTSDr, SQRTSSr, STC, STD, SUBPDrr, SUBPSrr, SUBSDrm, SUBSDrr,
       SUBSSrm, SUBSSrr, UD2B, V_SET0, V_SETALLONES, XCHG16rm, XCHG16rr,
