...
readWriteInfo i
  | i `elem`
      [ADDPDrr, ADDPSrr, ADDSDrm, ADDSDrr, ADDSSrm, ADDSSrr, ADDSUBPDrm,
       ...
       PSUBDrr, PSUBQrm, PSUBQrr, PSUBWrm, PSUBWrr, PUNPCKLBWrm,
       PUNPCKLBWrr, PUNPCKLDQrm, PUNPCKLDQrr, PUNPCKLQDQrm, PUNPCKLQDQrr,
       PUNPCKLWDrm, PUNPCKLWDrr, PUSHCS16, PUSHCS32, PUSHDS16, PUSHDS32,
       PUSHES16, PUSHES32, PUSHFS16, PUSHFS32, PUSHFS64, PUSHGS16,
       PUSHGS32, PUSHGS64, PUSHSS16, PUSHSS32, PXORrm, PXORrr, RETIL,
       RETIQ, RETIW, RETL, RETQ, RETW, REX64_PREFIX, RORX32ri, RORX64ri,
       ROUNDPDm, ROUNDPDr, ROUNDPSm, ROUNDPSr, ROUNDSDm, ROUNDSDr,
       ROUNDSSm, ROUNDSSr, SARX32rr, SARX64rr, SHLX32rr, SHLX64rr,
       SHRX32rr, SHRX64rr, SQRTSDr, SQRTSSr, STC, STD, SUBPDrr, SUBPSrr,
       SUBSDrm, SUBSDrr, SUBSSrm, SUBSSrr, UD2B, V_SET0, V_SETALLONES,
       XCHG16rm, XCHG16rr, XCHG32rm, XCHG32rr, XCHG64rm, XCHG64rr,
       XCHG8rm, XCHG8rr, XORPDrm, XORPDrr, XORPSrm, XORPSrr]
    = ([], [])
