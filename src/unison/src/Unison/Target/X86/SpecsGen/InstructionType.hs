...
instructionType i
  ...
  | i `elem`
      [ADC16i16, ADC16mi, ADC16mi8, ADC16mr, ADC16ri, ADC16ri8, ADC16rm,
       ...
       SUBSDrm, SUBSDrr, SUBSSrm, SUBSSrr, TEST16i16, TEST16mi, TEST16ri,
       TEST16rm, TEST16rr, TEST32i32, TEST32mi, TEST32ri, TEST32rm,
       TEST32rr, TEST64i32, TEST64mi32, TEST64ri32, TEST64rm, TEST64rr,
       TEST8i8, TEST8mi, TEST8ri, TEST8ri_NOREX, TEST8rm, TEST8rr,
       UCOMISDrm, UCOMISDrr, UCOMISSrm, UCOMISSrr, UD2B, V_SET0,
