...
allInstructions
  = [ADC16i16, ADC16mi, ADC16mi8, ADC16mr, ADC16ri, ADC16ri8,
     ...
     XORPSrr, STORE8, STORE16, STORE32, STORE64, STORE128, LOAD8,
     LOAD16, LOAD32, LOAD64, LOAD128, MOVE8, MOVE16, MOVE32, MOVE64,
     MOVE128, SUBRSP_pseudo, ADDRSP_pseudo, PUSH_cst, POP_cst, ADD64ur,
     ADD64ru, MOV8ri_source, MOV8ri_demat, MOV8ri_remat, MOV16ri_source,
