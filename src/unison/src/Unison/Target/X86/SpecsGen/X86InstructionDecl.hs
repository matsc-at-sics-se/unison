...
module Unison.Target.X86.SpecsGen.X86InstructionDecl
       (X86Instruction(..)) where
 
data X86Instruction = AAA
                    | AAD8i8
                    | AAM8i8
                    | AAS
                    | ACQUIRE_MOV16rm
                    ...
                    | VADDSUBPSYrm_unison
                    | VADDSUBPSrm_unison
                    | VAESDECLASTrm_unison
                    | VAESDECrm_unison
                    | VAESENCLASTrm_unison
                    | VAESENCrm_unison
                    | VAESIMCrm_unison
                    ...
                    | VBLENDVPSYrm_unison
                    | VBLENDVPSrm_unison
                    | VBROADCASTSDYrm_unison
                    | VBROADCASTSSYrm_unison
                    | VBROADCASTSSrm_unison
                    | VCMPPDYrmi_unison
                    | VCMPPDYrmi_alt_unison
                    | VCMPPDrmi_unison
                    | VCMPPDrmi_alt_unison
                    | VCMPPSYrmi_unison
                    | VCMPPSYrmi_alt_unison
                    | VCMPPSrmi_unison
                    | VCMPPSrmi_alt_unison
                    | VCMPSDrm_unison
                    | VCMPSDrm_alt_unison
                    | VCMPSSrm_unison
                    | VCMPSSrm_alt_unison
                    ...
                    | VHSUBPSYrm_unison
                    | VHSUBPSrm_unison
                    | VINSERTF128rm_unison
                    | VINSERTI128rm_unison
                    | VINSERTPSrm_unison
                    | VMAXCPDYrm_unison
                    | VMAXCPDrm_unison
                    | VMAXCPSYrm_unison
                    ...
                    | VPBLENDWYrmi_unison
                    | VPBLENDWrmi_unison
                    | VPBROADCASTBYrm_unison
                    | VPBROADCASTBrm_unison
                    | VPBROADCASTDYrm_unison
                    | VPBROADCASTDrm_unison
                    | VPBROADCASTQYrm_unison
                    ...
                    | VPCOMQmi_alt_unison
                    | VPCOMUBmi_unison
                    | VPCOMUBmi_alt_unison
                    | VPCOMUDmi_unison
                    | VPCOMUDmi_alt_unison
                    | VPCOMUQmi_unison
                    | VPCOMUQmi_alt_unison
                    | VPCOMUWmi_unison
                    | VPCOMUWmi_alt_unison
                    | VPCOMWmi_unison
                    | VPCOMWmi_alt_unison
                    | VPERM2F128rm_unison
                    | VPERM2I128rm_unison
                    ...
                    | VPTESTYrm_unison
                    | VPTESTrm_unison
                    | VPUNPCKHBWYrm_unison
                    | VPUNPCKHBWrm_unison
                    | VPUNPCKHDQYrm_unison
                    | VPUNPCKHDQrm_unison
                    | VPUNPCKHQDQYrm_unison
                    | VPUNPCKHQDQrm_unison
                    | VPUNPCKHWDYrm_unison
                    | VPUNPCKHWDrm_unison
                    | VPUNPCKLBWYrm_unison
                    | VPUNPCKLBWrm_unison
                    | VPUNPCKLDQYrm_unison
                    | VPUNPCKLDQrm_unison
                    | VPUNPCKLQDQYrm_unison
                    | VPUNPCKLQDQrm_unison
                    | VPUNPCKLWDYrm_unison
                    | VPUNPCKLWDrm_unison
                    | VPXORYrm_unison
                    | VPXORrm_unison
                    | VRCPPSYm_unison
